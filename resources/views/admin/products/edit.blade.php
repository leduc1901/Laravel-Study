                            ...
                            <div class="row" style="margin-bottom:40px">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantity" min="0" id="" class="form-control" value="{{$product->quantity}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <img id="avatar" class="thumbnail" width="100%" height="350px" src="/assets/admin/img/{{$product->avatar}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Thông tin</label>
                                        <textarea name="detail" style="width: 100%;height: 100px;" value="{{$product->detail}}"></textarea>
                                    </div>
                                 </div>
